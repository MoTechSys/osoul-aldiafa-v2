# تحليل تفصيلي شامل لمشروع أصول الضيافة
...
مشروع **أصول الضيافة** هو موقع تعريفي فاخر مبني على **Next.js 14 (App Router)** لشركة خدمات ضيافة سعودية. الموقع يعرض خدمات الشركة (مضيفون، قهوة سعودية، خدمات فنية، معدات) ويربط العملاء عبر واتساب. يتميز بتصميم بصري متقن (ذهبي + أسود) مع أنيميشن متقدم.
