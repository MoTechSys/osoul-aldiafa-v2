...
const storySections = [
  {
    title: "الضيافة عندنا مسؤولية قبل أن تكون مظهراً",
    body: "ننظر إلى الضيافة بوصفها وعداً للضيف بالترحيب، ووعداً للمعزّب بأن تبقى تفاصيل التقديم مرتبة من دون أن تشغله عن مناسبته. لذلك لا تبدأ خدمتنا من الدلّة ولا تنتهي عند الفنجان؛ تبدأ بفهم طبيعة اللقاء، وأسلوب الاستقبال، وعدد مساحات التقديم، والصورة التي يريدها صاحب المناسبة أمام ضيوفه. بعد ذلك نرتّب عناصر الضيافة بحيث يعمل كل جزء مع الآخر: حضور القهوجيين والصبابين، حركة التقديم، مظهر الأدوات، ومكان ركن القهوة. هدفنا أن تبدو الضيافة طبيعية في مجلسها، لا عرضاً منفصلاً عنه، وأن يشعر الضيف بالعناية من غير ضجيج أو مبالغة.",
  },
  {
    title: "أصالة تُفهم من التفاصيل",
    body: "الأصالة ليست زخرفة نضيفها في آخر لحظة، وليست مجموعة كلمات تراثية. تظهر في طريقة حمل الدلّة، وترتيب الفناجين، وهدوء الحركة، واحترام مساحة الضيف. ونؤمن أن المحافظة على روح الضيافة السعودية لا تعني تكرار شكل واحد في كل مناسبة؛ فلكل عزيمة طابعها، ولكل مجلس إيقاعه، ولكل معزّب ذوقه. لهذا نبحث عن التوازن بين الموروث والمشهد المعاصر: أدوات منسجمة، ألوان هادئة، وتقديم يحفظ المعنى من دون أن يثقل الصورة. ما يهمنا هو أن يرى الضيف مشهداً مألوفاً بروح مرتبة تليق بالمناسبة.",
  },
  {
    title: "كيف نرتّب تجربة المناسبة",
    body: "نبدأ بالسؤال قبل الاقتراح: ما نوع المناسبة؟ من هم الضيوف؟ كيف تتحرك الدعوة داخل المكان؟ وأين يكون حضور القهوة أكثر راحة؟ هذه الأسئلة تساعدنا على فهم الاحتياج الحقيقي بدل تقديم حل جاهز للجميع. ثم ننسّق الخدمة المتفق عليها، سواء كانت صبابين قهوة، قهوجيين ومباشرين، قهوجيات وصبابات، أو ركن قهوة عربية. نهتم بأن تكون الأدوار واضحة وأن يبقى مسار الضيوف مريحاً، مع مراعاة خصوصية المجالس وطبيعة اللقاء. وعندما تتضح الصورة، يعرف صاحب المناسبة ما الذي سيُرتّب له وما المعلومات التي نحتاجها منه قبل الموعد.",
  },
  {
    title: "فخامة هادئة لا تطغى على ضيوفك",
    body: "الفخامة في رؤيتنا ليست لمعاناً زائداً ولا ازدحاماً في المشهد. هي دقة في الاختيار، ونظافة في التكوين، وتناسق يجعل كل عنصر في مكانه. نفضّل حضوراً بصرياً هادئاً يكمّل المناسبة بدلاً من أن ينافسها، لأن بطل المشهد الحقيقي هو اللقاء نفسه. لذلك نفكّر في علاقة الأدوات بالمكان، ووضوح ركن الضيافة، وسهولة الوصول إليه، ومدى انسجامه مع هوية المناسبة. وحين تكون التفاصيل متوازنة، يلتقطها الضيف من أثرها: راحة في الاستقبال، ترتيب في التقديم، وصورة تحفظ للمجلس هيبته ودفأه.",
  },
  {
    title: "وضوح من أول تواصل",
    body: "نحترم وقت صاحب المناسبة، ولهذا نفضّل أن يكون التواصل مباشراً وواضحاً. نطلب المدينة، ونوع المناسبة، وتاريخها، وطبيعة المكان، والخدمة المطلوبة، ثم نبني الحديث على هذه المعلومات. لا نضع رقماً أو وعداً لا تدعمه تفاصيل الطلب، ولا نقدّم وصفاً عاماً على أنه خطة مكتملة. عندما تكون بعض المعلومات غير محسومة نقول ذلك بوضوح، وعندما يحتاج الاختيار إلى بدائل نعرضها بلغة مفهومة. هذا الوضوح ليس خطوة إدارية؛ هو جزء من الضيافة نفسها، لأنه يمنح المعزّب صورة واقعية تساعده على اتخاذ قراره بثقة.",
  },
  {
    title: "لمن نصنع هذه التجربة؟",
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }}>
            ...
            <p className="text-pearl/65 text-sm leading-8 mb-6">
              أصول الضيافة فكرة تقوم على معنى بسيط: أن يشعر الضيف بكرم الاستقبال، وأن يعيش المعزّب
              مناسبته مطمئناً إلى تفاصيل التقديم. نجمع بين روح الدلّة والفنجان وبين ترتيب يناسب شكل
              المناسبات اليوم، من دون أن نفقد هدوء الضيافة أو معناها.
            </p>
            <p className="text-pearl/65 text-sm leading-8">
              لا نقدّم قالباً واحداً لكل لقاء. نستمع أولاً، ثم نرتّب الخدمة بما يلائم نوع المناسبة،
              وطبيعة المكان، وأسلوب حضور الضيوف. بهذه الرؤية تصبح الضيافة جزءاً من التجربة، لا تفصيلاً
              مضافاً إليها.
            </p>
          </motion.div>
        </div>
      ...
      <section className="px-4 pb-16 sm:pb-24">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <p className="text-gold-bright text-xs mb-3" style={{ letterSpacing: "0.35em" }}>✦ طريقتنا ✦</p>
            <h2 className="text-pearl font-amiri" style={{ fontSize: "clamp(1.6rem, 4vw, 2.4rem)", fontWeight: 700 }}>
              ما الذي تعنيه أصول الضيافة لنا؟
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {storySections.map((section) => (
              <article key={section.title} className="card-royal p-6 sm:p-8">
                <h3 className="text-pearl font-amiri mb-4" style={{ fontSize: "1.25rem", fontWeight: 700 }}>
                  {section.title}
                </h3>
                <p className="text-pearl/65 text-sm leading-8">{section.body}</p>
              </article>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {values.map((v, i) => (
              ...
              >
                ...
                <p className="text-pearl/75 text-sm">{v.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
