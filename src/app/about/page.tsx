...
export const metadata: Metadata = generatePageMetadata({
  title: "من نحن — فريق قهوجيين وصبابين محترف",
  description:
    "أصول الضيافة منذ 2017 — نُحيي أصول الضيافة العربية الأصيلة بفريق صبّابين وقهوجيين بزي تراثي وأدوات تقديم ذهبية في جدة وينبع، ونصل إلى بقية مناطق المملكة.",
  path: "/about",
  keywords: [
    "عن أصول الضيافة",
    "شركة ضيافة سعودية",
