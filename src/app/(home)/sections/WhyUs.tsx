...
const whyTiles = [
  ...
  },
  {
    ...
    // قرار المالك 2026-08-29: التغطية كل المملكة، والتركيز على جدة وينبع.
    title: "نصل إلى كل مناطق المملكة",
    desc: "تركيزنا الأساسي جدة وينبع، وطاقمنا وعدّتنا يصلون إلى أي مدينة في المملكة — من مكة والمدينة وبدر إلى الرياض والدمام وأبها.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-7 h-7">
