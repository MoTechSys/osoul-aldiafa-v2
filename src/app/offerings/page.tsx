...
export const metadata: Metadata = generatePageMetadata({
  title: "تقديمات ضيافة: قهوة عربية وتمور وشاي",
  description:
    "قهوة عربية أصيلة وشاي مزهّر، تمور فاخرة، معمول ومكسرات، دلال ذهبية وفناجين منقوشة — تعرّف على كل تقديمات أصول الضيافة في مكان واحد.",
  path: "/offerings",
  keywords: [
    "قهوة عربية",
    "شاي فاخر",
