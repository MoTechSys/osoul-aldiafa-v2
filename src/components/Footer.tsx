        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a href="mailto:osoulaldiafa@gmail.com" className="flex items-start gap-3 text-pearl/55 text-sm hover:text-gold-bright transition-colors duration-200 min-h-[36px]">
                <span className="mt-0.5 flex-shrink-0">
                ...
                <span>osoulaldiafa@gmail.com</span>
              </a>
