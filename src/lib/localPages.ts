...
export type LocalCity = {
  ...
  districts: string[]; // أسماء أحياء تُعرض كنص داخل صفحة المدينة فقط — ❌ لا تُبنى منها أي صفحة (R3)
  lat?: number;
  lng?: number;
...
export const CITIES: Record<string, LocalCity> = {
  ...
  yanbu: {
    ...
    lng: 38.045997,
    intro:
      "مدينتنا الأم وقلب انطلاقتنا — نغطّي ينبع البحر وينبع الصناعية والهيئة الملكية بخدمة ضيافة حاضرة بسرعة وكفاءة.",
  },
  badr: {
    slug: "badr",
    ar: "بدر",
