...
export type SubPage = {
   ...
   * تُعرض في أول المحتوى بعد الهيرو (قابلة للاقتباس من محركات الإجابة).
   * قواعد ملزمة: لا أرقام غير موثّقة (R9/S10)، لا كلمة «فرع» (N9)،
   * تتضمن اسم الكيان + الخدمة + المدينة/النطاق + قناة الحجز.
   * الحقل إلزامي — كل صفحة فرعية جديدة يجب أن تبدأ بإجابة.
   */
  directAnswer: string;
  heroImage: string;
  heroAlt: string;
